...
% checkboxes for plots, show 1, 2, 3 corespond to the plot see below
...
%xlabel('Time (days)')
ylabel('Number/m^2','Fontweight','demi', 'Fontsize',16)
...
ylabel('Prevalence (%)','Fontweight','demi', 'Fontsize',16)
prev(end)
ylim([0 102])
...
%xlabel('t (days)')
ylabel('Number/day','Fontweight','demi', 'Fontsize',16)
...
set(gca,'fontsize',12)
%xlabel('t (days)')
ylabel('Number/m^3','Fontweight','demi', 'Fontsize',16)
%title('Prevalence')
